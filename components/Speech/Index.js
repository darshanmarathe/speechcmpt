/**
 * code copied from https://github.com/ai/audio-recorder-polyfill
 * demo referrence: https://github.com/husenxce-zz/siriwaveDemo
 *
 * Changes:
 *  - coupled siriwave to new instance of the class
 *  - added analyser object
 */
...
class MediaRecorder {
  ...
  start(timeslice) {
    ...
    // added from default dependency
    this.analyser = context.createAnalyser();
    this.analyser.fftSize = 4096;
    this.myDataArray = new Float32Array(this.analyser.frequencyBinCount);
    ...
    this.processor.onaudioprocess = (e) => {
      ...
      this.analyser.getFloatFrequencyData(this.myDataArray);

      //get max frequency which is greater than -100 dB.
      this.myDataArray.map((item, index) => {
      ...
      //scale amplituded from [-1, 1] to [0, 2].
      amplitude = Math.abs(amplitude * 2);
